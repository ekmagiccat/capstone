          ...
          <AccordionDetails>
            <Typography>
              <ol>
                ...
                <li>
                  Add the ground coffee to the filter and gently tap it to level
                  the surface of the grounds.
                </li>
                <li>
                  Place the brewer on a carafe or cup, place this entire set-up
                ...
                <li>
                  ...
                  should take about 15 seconds. Give the coffee an additional 30
                  seconds to bloom before moving on to the second pour.
                </li>
                <li>
                  Starting in the center of the grounds, pour in a steady spiral
                  toward the outer edge and then back toward the center. Add
                  roughly 90 grams, bringing the total to 150 grams. The goal
                  during this pour is to sink all of the grounds on the surface
                  of the bed. This creates a gentle turbulence that “stirs” the
                  coffee, allowing water to more evenly extract the grounds.
