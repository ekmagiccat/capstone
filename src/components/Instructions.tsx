      ...
      <div className="card">
        ...
        <div className="card-body">
          ...
          <ol>
            ...
            <li>
              Place the brewer on a carafe or cup, place this entire set-up onto
              a digital scale, and set it to zero.
            </li>
            <li>
              Start a timer. Begin pouring water slowly over the coffee,
              starting at the center and moving in a steady spiral toward the
              edge and back again. Stop pouring when the scale reaches 60 grams.
              Make sure all the grounds are saturated. The pour should take
              about 15 seconds. Give the coffee an additional 30 seconds to
              bloom before moving on to the second pour.
            </li>
            <li>
              ...
              90 grams, bringing the total to 150 grams. The goal during this
              pour is to sink all of the grounds on the surface of the bed. This
              creates a gentle turbulence that “stirs” the coffee, allowing
              water to more evenly extract the grounds. Allow 45-65 seconds to
              elapse.
            </li>
            <li>
